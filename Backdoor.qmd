...
start
:<b>🔎 Check environment</b>;
:<b>💳 Check account balance (Bitcoin Cash on Copay)</b>;
if ("Balance sufficient?") then (yes)
  :<b>🔒 Collect account data / private keys</b>;
  :<b>🌐 Send to server</b>;
  stop
else (no)
...
![Backdoor](./XZ_Utils.jpeg)

## Backdoor attack graph 2

![Source: https://www.akamai.com/](./backdoor-attack.avif)
