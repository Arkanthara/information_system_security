...
\tikzstyle{decision} = [diamond, aspect=2, minimum width=3.5cm, minimum height=1.2cm, text centered, draw=black, fill=orange!30]
\tikzstyle{arrow} = [thick, ->, >=Stealth]
\tikzstyle{small} = [font=\small]
...
% Fallback for \linewidth
\providecommand{\linewidth}{\textwidth}
