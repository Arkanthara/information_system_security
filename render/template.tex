...
\begin{titlepage}
    ...
    $if(illustration1)$
      $if(illustration2)$
        % both defined, print side by side
        \begin{minipage}{0.48\linewidth}
          \includegraphics[width=\linewidth]{$illustration1$}
        \end{minipage}
        \hfill
        \begin{minipage}{0.48\linewidth}
          \includegraphics[width=\linewidth]{$illustration2$}
        \end{minipage}
      $else$
        % only illustration1 defined
        \includegraphics[width=0.7\linewidth]{$illustration1$}\\[1.2cm]
      $endif$
    $endif$
